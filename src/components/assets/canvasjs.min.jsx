...
(function () {
    ...
    function gb(h) {
      ...
      if (h.exportEnabled && h._dropdownMenu) {
        ...
        for (
          var w = h._dropdownMenu.childNodes,
            s = [
    ...
    function Ra(h, m, w, s, u) {
      ...
      "undefined" !== typeof s &&
        ((h = Math.min(s, h)), "undefined" !== typeof u && (h = Math.max(u, h)));
        ...
        : this.parent &&
          ...
          (null === u
            ...
            : 0 < this.parent.themeOptions[m].length &&
              ...
              (h = this.parent.themeOptions[m][u])));
      this.themeOptions = h;
          ...
          try {
            ...
            w =
              "cm" === T.pos[m] || "um" === T.pos[m]
                ? 0
                : h.width - u[T.fSDec(T.obj.msrTxt)](T.fSDec(T.obj.wm)).width;
    ...
    var fb = (function () {
      ...
      ca = function (h, m, w, s, u, y, D, F, N, M, T, Q, J) {
        ...
        0 < D &&
          ...
          (h.strokeStyle = F),
          h.moveTo(m, w),
          h.rect(m - J, w - J, s - m + 2 * J, u - w + 2 * J),
          h.stroke());
        h.restore();
        !0 === N &&
          (h.save(),
    ...
    V.prototype.setOptions = function (h, m) {
      if (pa[this._defaultsKey]) {
        ...
        for (u in s)
          "publicProperties" !== u &&
            s.hasOwnProperty(u) &&
            (this[u] = h && u in h ? h[u] : m && u in m ? m[u] : s[u]);
    ...
    V.prototype.updateOption = function (h) {
      ...
      this.theme && s(this.parent) && s(F) && s(H)
        ...
        : this.parent &&
          ...
          (null === H
            ? (u = this.parent.themeOptions[F])
            : 0 < this.parent.themeOptions[F].length &&
              ((u = Math.min(this.parent.themeOptions[F].length - 1, H)),
              (u = this.parent.themeOptions[F][u])));
      this.themeOptions = u;
      h in m &&
        (y = h in this.options ? this.options[h] : u && h in u ? u[h] : m[h]);
    ...
    V.prototype.dispatchEvent = function (h, m, s) {
      if (h && this._eventListeners[h]) {
        m = m || {};
        for (var u = this._eventListeners[h], y = 0; y < u.length; y++)
      ...
      if (0 !== this.fontSize) {
        ...
        for (s = 0; s < this._wrappedText.lines.length; s++) {
          ...
          if ("right" === this.horizontalAlign || "right" === this.textAlign)
            u = this.width - F.width - this.rightPadding;
    ...
    y = Oa.Chart = (function () {
        ...
        for (var c = [], b, e = 0; e < a.length; e++)
          if (0 == e) c.push(a[0]);
            ...
            b =
              (Math.abs(
                (a[l].x - a[f].x) /
                  (0 === a[l].x - a[v].x ? 0.01 : a[l].x - a[v].x)
              ) *
                (d - 1)) /
                2 +
              1;
            ...
            b = (a[l].y - a[f].y) / b;
            c[c.length] =
              (a[v].x > a[f].x && 0 < A) || (a[v].x < a[f].x && 0 > A)
                ? { x: a[v].x + A / 3, y: a[v].y + b / 3 }
                : { x: a[v].x, y: a[v].y + b / 9 };
            v = e;
            f = 0 === v ? 0 : v - 1;
            l = v === a.length - 1 ? v : v + 1;
            b =
              (Math.abs(
                (a[l].x - a[f].x) /
                  (0 === a[v].x - a[f].x ? 0.01 : a[v].x - a[f].x)
              ) *
                (d - 1)) /
                2 +
              1;
      ...
      m.prototype.renderElements = function () {
        ...
        for (d = 0; d < this.plotInfo.plotTypes.length; d++)
          for (
            ...
            v.targetCanvas = null;
            this.animatedRender &&
              ((v.targetCanvas = ta(this.width, this.height)),
              (v.targetCanvasCtx = v.targetCanvas.getContext("2d")),
              (e = v.targetCanvasCtx.miterLimit),
              (v.targetCanvasCtx.miterLimit = 3));
            "line" === v.type
              ? (A = this.renderLine(v))
              : "stepLine" === v.type
            ...
            for (var k = 0; k < v.dataSeriesIndexes.length; k++)
              this._dataInRenderedOrder.push(this.data[v.dataSeriesIndexes[k]]);
            this.animatedRender &&
              ((v.targetCanvasCtx.miterLimit = e), A && c.push(A));
          }
            ...
            if ("normal" === v.axisPlacement || "xySwapped" === v.axisPlacement)
              var q = a.axisX.sessionVariables.newViewportMinimum
                ...
                g = a.axisX.sessionVariables.newViewportMaximum
                  ...
                  : Infinity;
            if (
              (v.dataPoints[A].x && v.dataPoints[A].x.getTime) ||
              "dateTime" === v.xValueType
            )
              f = !0;
            for (A = 0; A < v.dataPoints.length; A++) {
              "undefined" === typeof v.dataPoints[A].x &&
                (v.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0));
              v.dataPoints[A].x.getTime
                ? ((f = !0), (b = v.dataPoints[A].x.getTime()))
                : (b = v.dataPoints[A].x);
              e = v.dataPoints[A].y;
              b < c.min && (c.min = b);
              b > c.max && (c.max = b);
              ...
              if (b < q && !k) null !== e && (p = b);
                ...
                v.dataPoints[A].label &&
                  (a.axisX.labels[b] = v.dataPoints[A].label);
          ...
          for (
            ...
            for (n = 0; n < k.dataPoints.length; n++) {
              ...
              k.dataPoints[n].x.getTime
                ? ((v = !0), (b = k.dataPoints[n].x.getTime()))
                : (b = k.dataPoints[n].x);
        ...
        if (
          ...
          for (
            ...
            if (
              ...
              f = !0;
            for (A = 0; A < v.dataPoints.length; A++)
              "undefined" !== typeof v.dataPoints[A].isCumulativeSum &&
              !0 === v.dataPoints[A].isCumulativeSum
                ? ((v.dataPointEOs[A].cumulativeSumYStartValue = 0),
                  (v.dataPointEOs[A].cumulativeSum =
                    0 === A ? 0 : v.dataPointEOs[A - 1].cumulativeSum),
                  (v.dataPoints[A].y =
                    0 === A ? 0 : v.dataPointEOs[A - 1].cumulativeSum))
                : "undefined" !== typeof v.dataPoints[A].isIntermediateSum &&
                ...
                ? ((v.dataPointEOs[A].cumulativeSumYStartValue = p),
                  ...
                  (b = 0))
                : ((e =
                    "number" !== typeof v.dataPoints[A].y
                      ? 0
                      : v.dataPoints[A].y),
                  (v.dataPointEOs[A].cumulativeSumYStartValue =
                    0 === A ? 0 : v.dataPointEOs[A - 1].cumulativeSum),
                  (v.dataPointEOs[A].cumulativeSum =
                    0 === A ? e : v.dataPointEOs[A - 1].cumulativeSum + e),
                  (b += e));
            for (A = 0; A < v.dataPoints.length; A++)
              if (
                ("undefined" === typeof v.dataPoints[A].x &&
                ...
                b < c.min && (c.min = b),
                b > c.max && (c.max = b),
                v.dataPointEOs[A].cumulativeSum < d.min &&
                  (d.min = v.dataPointEOs[A].cumulativeSum),
                v.dataPointEOs[A].cumulativeSum > d.max &&
                  (d.max = v.dataPointEOs[A].cumulativeSum),
                0 < A &&
                  (a.axisX.logarithmic
                    ? ((p = b / v.dataPoints[A - 1].x),
                      1 > p && (p = 1 / p),
                  ...
                  null !== e &&
                    ...
                    (a.axisY.logarithmic
                      ? ((e =
                          v.dataPointEOs[A].cumulativeSum /
                          v.dataPointEOs[A - 1].cumulativeSum),
                        1 > e && (e = 1 / e),
                ...
                b > c.viewPortMax && (c.viewPortMax = b);
                0 < A &&
                  (v.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin &&
                    (d.viewPortMin = v.dataPointEOs[A - 1].cumulativeSum),
                  v.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax &&
                    (d.viewPortMax = v.dataPointEOs[A - 1].cumulativeSum));
                v.dataPointEOs[A].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = v.dataPointEOs[A].cumulativeSum);
                v.dataPointEOs[A].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = v.dataPointEOs[A].cumulativeSum);
              }
            v.axisX.valueType = v.xValueType = f ? "dateTime" : "number";
          }
      };
      m.prototype.calculateAutoBreaks = function () {
                    ...
                    if (
                      (b &&
                        ((q =
                          ...
                          100),
                        (g = h.dataPoints[v].x.getTime
                          ? h.dataPoints[v].x.getTime()
                          : h.dataPoints[v].x),
                        (q = Math.floor((g - k) / q)),
                        g < f[q].min && (f[q].min = g),
                        g > f[q].max && (f[q].max = g)),
                      ...
                      if (
                        (g =
                          "waterfall" === a.type
                            ? h.dataPointEOs[v].cumulativeSum
                            : h.dataPoints[v].y) &&
                        g.length
                      )
                        for (var u = 0; u < g.length; u++)
                          (q = Math.floor((g[u] - n) / m)),
        ...
        if (f) {
          for (l = 0; l < this.plotInfo.plotTypes.length; l++)
            for (
              f = this.plotInfo.plotTypes[l], v = 0;
              v < f.plotUnits.length;
              v++
            )
              (b = f.plotUnits[v]),
                "line" === b.type ||
          ...
          for (l = 0; l < this._axes.length; l++)
            if (this._axes[l].dataInfo._dataRanges) {
              ...
              if (this._axes[l].scaleBreaks.customBreaks)
                for (
                  v = 0;
                  v < this._axes[l].scaleBreaks.customBreaks.length;
                  v++
                )
                  for (b = 0; b < f.length; b++)
                    if (
                      (this._axes[l].scaleBreaks.customBreaks[v].startValue <=
                        f[b].start &&
                        f[b].start <=
                          this._axes[l].scaleBreaks.customBreaks[v].endValue) ||
                      (this._axes[l].scaleBreaks.customBreaks[v].startValue <=
                        f[b].start &&
                        f[b].start <=
                          this._axes[l].scaleBreaks.customBreaks[v].endValue) ||
      ...
      m.prototype.renderIndexLabels = function (a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
          ...
          if (
            ...
            E = this.getPercentAndTotal(n.dataSeries, n.dataPoint);
            ...
            if ("normal" === this.plotInfo.axisPlacement) {
              ...
              "inside" !== E
                ? ((e = c.y1),
                  ...
                  0 < w
                    ? ((g =
                        n.point.y + ("horizontal" === B ? r / 2 : 0) - k - v - b),
                      g < e &&
                        ((g =
                          "auto" === E
                            ? Math.max(n.point.y, e) + r / 2 + v
                            : e + r / 2 + v),
                        (y = g + k > n.point.y)))
                    : ((g = n.point.y + r / 2 + v + b),
                      g > f - k &&
                ...
                : ((e = Math.max(n.bounds.y1, c.y1)),
                  ...
                  0 < w
                    ? ((g = Math.max(n.point.y, b)),
                      g < e &&
                        ("bubble" === p || "scatter" === p) &&
                        (g = Math.max(n.point.y - k - v, c.y1 + v)))
                    : ((g = Math.min(n.point.y, b)),
                      g > f - k - v &&
                        ("bubble" === p || "scatter" === p) &&
                        (g = Math.min(n.point.y + v, c.y2 - k - v))),
                  (g = Math.min(g, f)));
            } else
              0 <= p.indexOf("line") ||
              0 <= p.indexOf("area") ||
                  ...
                  ? ((e = c.x1),
                    ...
                    0 > w
                      ? ((q =
                        ...
                        q < e &&
                          ((q =
                            "auto" === E ? Math.max(n.point.x, e) + l : e + l),
                          (y = q + A > n.point.x)))
                      : ((q =
              ...
              for (k = 0; k < t.length; k++)
                if (
                  ...
                  if (
                    ...
                    (A[b] = E + (A[b] ? A[b] : 0)),
                      (n = l[b] ? l[b] : q),
                      (l[b] = E = a.axisY.convertValueToPixel(A[b]));
              ...
              for (var aa = !0, q = 0; q < n.length; q++) {
                ...
                if (
                  ...
                  if ("number" !== typeof fa.y)
                    ...
                    x || aa
                      ? (!x && z.connectNullData
                          ? (b.setLineDash &&
                              ...
                              k.push(E),
                              k.push(x),
                              (E = z.nullDataLineDashType),
                              b.setLineDash(P)),
                            b.lineTo(g, r),
                            u && s.lineTo(g, r))
                          : (b.beginPath(),
                            b.moveTo(g, r),
                            u && (s.beginPath(), s.moveTo(g, r))),
                        (aa = x = !1))
                      : (b.lineTo(g, r),
                        u && s.lineTo(g, r),
                        0 == q % 250 &&
                    ...
                    q < w.length - 1 &&
                      (S !== (w[q].lineColor || y) ||
                        E !== (w[q].lineDashType || z.lineDashType)) &&
                      (d(),
                      b.beginPath(),
                      b.moveTo(g, r),
                      k.push({ x: g, y: m - ma }),
                      ...
                      b.setLineDash &&
                        (w[q].lineDashType
                          ? ((E = w[q].lineDashType),
                            b.setLineDash(N(E, z.lineThickness)))
                          : ((E = z.lineDashType), b.setLineDash(D))));
                    ...
                    q < y.length - 1 &&
                      ...
                      b.setLineDash &&
                        (y[q].lineDashType
                          ...
                          : ((t = z.lineDashType), b.setLineDash(F))));
                    if (0 <= z.dataPointIndexes[f]) {
      ...
      m.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
          ...
          for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
            ...
            if (0 < x.length)
              for (
                var E = 5 < r && t.bevelEnabled ? !0 : !1, v = 0;
                v < x.length;
                v++
              )
                if (
                  ...
                  "candlestick" === t.type
                    ? (c.moveTo(h - y, n),
                      ...
                      ca(
                        ...
                        C,
                        Math.max(k, q),
                        x[v].y[0] <= x[v].y[3] ? t.risingColor : f,
                        z,
                        e,
                        E,
                        E,
              ...
              for (
                ...
                if (
                  ...
                  u &&
                    ...
                    0 < ba &&
                      (b.moveTo(v - D - G, k),
                      b.lineTo(v - D - G, Math.max(h, p)),
                      b.stroke(),
                      b.moveTo(v - D - G, Math.min(h, p)),
                      b.lineTo(v - D - G, n),
                      b.stroke()),
                    ca(
                      b,
                    ...
                    0 < P &&
                      (b.beginPath(),
                      (b.lineWidth = P),
                      b.moveTo(v + aa / 2, p - fa),
                      b.lineTo(v - aa / 2, p - fa),
                      b.stroke(),
                      b.moveTo(v + aa / 2, h + fa),
                      b.lineTo(v - aa / 2, h + fa),
                      b.stroke()));
                  (E[l].indexLabel ||
                    x.indexLabel ||
            ...
            if (0 < C.length)
              for (var F = B._colorSet, v = 0; v < C.length; v++) {
                var e = (B.lineColor = B.options.color ? B.options.color : F[0]),
                  S = {
                    color: C[v].whiskerColor
                      ...
                      ? B.whiskerColor
                      : e,
                    thickness: s(C[v].whiskerThickness)
                      ? B.whiskerThickness
                      : C[v].whiskerThickness,
                    dashType: C[v].whiskerDashType
                      ? C[v].whiskerDashType
                      : B.whiskerDashType,
                    length: s(C[v].whiskerLength)
                      ? s(B.options.whiskerLength)
                        ? t
                        : B.options.whiskerLength
                      : C[v].whiskerLength,
                    trimLength: s(C[v].whiskerLength)
                      ? s(B.options.whiskerLength)
                        ? 50
                        : 0
                      : 0,
                ...
                if (
                  ...
                  !s(C[v].y) &&
                  C[v].y.length &&
                  "number" === typeof C[v].y[0] &&
                  "number" === typeof C[v].y[1]
                ) {
        ...
        function d() {
          if (x) {
            for (var a = null, c = m.length - 1; 0 <= c; c--)
              (a = m[c]), b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2);
            b.closePath();
            b.globalAlpha = n.fillOpacity;
            b.fill();
            b.globalAlpha = 1;
                      ...
                      b.setLineDash &&
                        (p[g].lineDashType
                          ? ((z = p[g].lineDashType),
                            ...
                            b.setLineDash(m[m.length - 1].newLineDashArray))
                          : ((z = n.lineDashType),
                            (m[m.length - 1].newLineDashArray = D),
                            b.setLineDash(D))));
                    if (
      ...
      m.prototype.renderPie = function (a) {
        ...
        function f(a, c, d) {
          ...
          if (0 <= a && a < n.length) {
            ...
            l =
              "right" === h.hemisphere
                ? E.x + Math.sqrt(Math.pow(u, 2) - Math.pow(c - E.y, 2))
                : E.x - Math.sqrt(Math.pow(u, 2) - Math.pow(c - E.y, 2));
            ...
            k &&
              ...
              (c =
                "right" === h.hemisphere
                  ? E.x + Math.sqrt(Math.pow(u, 2) - Math.pow(d - E.y, 2))
                  : E.x - Math.sqrt(Math.pow(u, 2) - Math.pow(d - E.y, 2))),
              ...
              (h.indexLabelAngle = Math.atan2(
                h.indexLabelTextBlock.y - E.y,
                h.indexLabelTextBlock.x - E.x
              )));
          }
          return k;
        }
        function l() {
          ...
          for (
            ...
            if ("inside" !== k.indexLabelPlacement) {
              ...
              for (a = 0; a < n.length; a++)
                (h = g[a]),
                  (u = "pie" === k.type ? 0.7 * z : 0.8 * z),
                  (t = E.x + u * Math.cos(h.midAngle)),
                  (s = E.y + u * Math.sin(h.midAngle)),
                    ...
                    (!l &&
                      ...
                      ((s =
                        0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                          ...
                          : 1),
                      0 === f(a, t * s) && f(a, 2 * s)),
                    Math.abs(h.indexLabelTextBlock.x - E.x) < z &&
      ...
      m.prototype.renderFunnel = function (a) {
          ...
          if (e)
            for (l = I.length - 1; 0 <= l; l--)
              (a = O[l]),
                ...
                t.reversed
                  ? (I[l].textBlock.y + I[l].height > na + B &&
                      (I[l].textBlock.y = na + B - I[l].height),
                    I[l].textBlock.y < sa - B && (I[l].textBlock.y = sa - B))
                  : (I[l].textBlock.y < na - B && (I[l].textBlock.y = na - B),
                    I[l].textBlock.y + I[l].height > sa + B &&
                      (I[l].textBlock.y = sa + B - I[l].height));
        }
        function f() {
          var a, b, c, d;
            ...
            for (var e = 0; e < O.length; e++)
              0 == I[e].textBlock.text.length
                ...
                : ((a = O[e]),
                  ...
                  t.reversed
                    ? (I[e].textBlock.y + I[e].height > na + B &&
                        (I[e].textBlock.y = na + B - I[e].height),
                      I[e].textBlock.y < sa - B && (I[e].textBlock.y = sa - B))
                    : (I[e].textBlock.y < na - B && (I[e].textBlock.y = na - B),
                      I[e].textBlock.y + I[e].height > sa + B &&
                        (I[e].textBlock.y = sa + B - I[e].height)));
          else
        ...
        function h(a, b) {
          return (
            (b < O.length ? I[b].textBlock.y : t.reversed ? na + B : sa + B) -
            (0 > a
              ? t.reversed
                ? sa - B
                : na - B
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
          for (
            var t = this.data[a.dataSeriesIndexes[0]],
              ...
              z = 0,
              D = E.height - 2 * B,
              F = Math.min(E.width - 2 * C, 2.8 * E.height),
              H = !1,
              P = 0;
            P < x.length;
            P++
      ...
      D.setLayout = function (a, d, c, b, e, f) {
        ...
        for (g = 0; g < q.length; g++)
          if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
            for (
              var r = q[g].scaleBreaks._appliedBreaks, u = 0;
              u < r.length && !(r[u].startValue > q[g].viewportMaximum);
              u++
            )
              r[u].endValue < q[g].viewportMinimum ||
                (s(q[g].scaleBreaks.firstBreakIndex) &&
                  (q[g].scaleBreaks.firstBreakIndex = u),
                r[u].startValue >= q[g].viewPortMinimum &&
        ...
        if (this.snapToDataPoint) {
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (B) {
              if ("axisX" === this.parent.type)
                for (
                  r = this.parent.convertPixelToValue({ x: a }), u = null, w = 0;
                  w < this.parent.dataSeries.length;
                  w++
                )
                  (u = this.parent.dataSeries[w].getDataPointAtX(r, !0)) &&
